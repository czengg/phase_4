...
class DojoStudentsControllerTest < ActionController::TestCase
  ...
  test "should update dojo_student" do
    put :update, id: @dojo_student, dojo_student: { dojo_id: @dojo_student.dojo_id, end_date: @dojo_student.end_date, start_date: @dojo_student.start_date, student_id: @dojo_student.student_id }
    assert_redirected_to dojo_student_path(assigns(:dojo_student))
  end
